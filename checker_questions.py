...
# !/usr/bin/env python3
# Ameer Khan,Michelob Revol,Kyle Deveaux, Project 1,06.17.2022
...
class Checker(TwoPlayerGame):
    ...
    def make_move(self, pos):
        ...
        ------
        """
        # assigning board pieces to current player position
    ...
    def lose(self):
        ...
        for i,j in self.black_territory:
          if self.board[i,j] == "W":
            print('White wins')
            #print function for white player
            return True
          else:
            return False
